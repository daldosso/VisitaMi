Ext.define('Bike.controller.Bike', {
    ...
    onBikeItemTap: function(list, index, target, record) {
        if (!this.ciclabile) {
            this.ciclabile = Ext.widget('ciclabile');
        }
        this.getBikeContainer().push(this.ciclabile);
    }
